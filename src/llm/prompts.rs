...
{area_rule}
9. Si las líneas traen prefijo de hablante: "yo:" es el usuario local (dueño de esta nota) y "ellos:" son los demás participantes. Úsalo para atribuir decisiones y "who" en action_items: lo que dice "yo" comprometerse a hacer es del usuario local; lo que "ellos" se comprometen es de la persona correspondiente. Ojo con el eco: si la reunión sonó por parlantes, el micrófono también capta a los demás, así que una línea "yo:" que repite casi textual una línea "ellos:" cercana es eco y la dijeron "ellos", no el usuario.
...
9. Si las líneas traen prefijo de hablante: "yo:" es el usuario local (dueño de esta nota) y "ellos:" son los demás participantes. Úsalo para atribuir decisiones y "who" en action_items. Ojo con el eco: si la reunión sonó por parlantes, el micrófono también capta a los demás, así que una línea "yo:" que repite casi textual una línea "ellos:" cercana es eco y la dijeron "ellos", no el usuario.
