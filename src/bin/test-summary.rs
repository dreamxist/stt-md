...
[00:00] Diego: Ok, vamos al standup de Acme. Juan, ¿cómo viene el onboarding?
...
[00:18] Diego: Bacán. Para el sprint que viene priorizamos integración con Linear para tracking de bugs.
[00:25] Juan: Sí, eso queda para mí, deadline jueves próximo.
[00:32] Diego: Tema importante, hay que migrar el endpoint de auth antes del 5 de mayo, riesgo de que rompa producción si no.
[00:42] María: Yo me encargo de avisar al cliente Acme sobre el cambio.
[00:50] Diego: Listo. Última cosa, María, ¿cómo va el rediseño del feed?
